...
public class ValueMarshalerTest {
	...
	public void shouldConvertValueToString() {
		Value value = new Value(2, "A", LocalDateTime.of(2017, 1, 5, 17, 1), "This is a real value");
		String marshalledValue = ValueMarshaler.marshal(value);
		assertTrue(marshalledValue.equals("2;A;2017-01-05T17:01;This is a real value"));
	}
	
	@Test
	public void shouldUnmarshalStringToValue() {
		String value = "2;A;2017-01-05T17:01;This is a real value";
		Value valueObject = ValueMarshaler.unmarshal(value);
		assertTrue(valueObject.getPermission() == 2);
		assertTrue(valueObject.getUsername().equals("A"));
